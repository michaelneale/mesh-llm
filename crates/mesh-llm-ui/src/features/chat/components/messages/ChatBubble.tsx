...
import { modelRefLabel } from '@/features/app-shell/lib/status-helpers'
import { cn } from '@/lib/utils'
import { messageAttachments } from '@/features/chat/lib/chat-attachments'
          ...
          <div className="mb-2 space-y-2">
            {attachments.map((attachment) =>
              attachment.kind === 'image' ? (
                ...
                <div key={attachment.id} className="rounded-lg border bg-muted/40 p-3">
                ...
                <div key={attachment.id} className="rounded-lg border bg-muted/40 p-3 text-sm">
