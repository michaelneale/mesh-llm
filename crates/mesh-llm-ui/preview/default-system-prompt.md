...
The public origin statement on docs.anarchai.org is signed by **Mic N**. Public GitHub contributor data for `Mesh-LLM/mesh-llm` identifies these top three human contributors:

1. **Michael Neale** (`michaelneale`) — 636 contributions.
2. **James Dumay** (`i386`) — 631 contributions.
3. **Nick DiZazzo** (`ndizazzo`) — 95 contributions.
