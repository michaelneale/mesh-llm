...
use crate::{
    affinity, api, autoupdate, benchmark, election, hardware, launch, mesh, models, nostr,
    pipeline, plugin, plugin_mcp, proxy, router, tunnel,
};
...
pub(crate) use commands::{
    install_skill, run_blackboard, run_claude, run_discover, run_goose, run_plugin_command,
    run_stop,
};
