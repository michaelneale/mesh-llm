...
type ComposerProps = { value: string; onChange: (value: string) => void; onSend: () => void; placeholder?: string; disabled?: boolean }

export function Composer({ value, onChange, onSend, placeholder = 'Ask me anything\u2026', disabled = false }: ComposerProps) {
  ...
  return (
    ...
    >
      <label className="sr-only" htmlFor="prompt-composer">Prompt</label>
      <textarea
        id="prompt-composer"
      ...
      <div className="flex items-center justify-between border-t border-border-soft bg-panel px-3.5 py-2">
        ...
        <div className="flex items-center gap-1.5">
          <button type="button" className="ui-control inline-flex size-7 items-center justify-center rounded-[var(--radius)] border" aria-label="Attach"><Paperclip className="size-[13px]" /></button>
          <button type="button" className="ui-control inline-flex size-7 items-center justify-center rounded-[var(--radius)] border" aria-label="System prompt"><Code2 className="size-[13px]" /></button>
          <button type="button" className="ui-control inline-flex size-7 items-center justify-center rounded-[var(--radius)] border" aria-label="Retry last"><RotateCcw className="size-[13px]" /></button>
          <button
